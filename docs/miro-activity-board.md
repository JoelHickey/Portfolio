...
Create **frames** (or sections) for each area. Suggested layout: left-to-right or top-to-bottom flow.
...
- **Links (stickies or text):**
  ...
  - [The TurboChat](https://theturbochat.com)

---

### Frame 2: Round 1 — Vibe prompts
...
### Frame 3: Round 2 — Agentic prompts
...
### Frame 5: Cheat sheet (optional)

**Title:** Vibe vs agentic — Quick reference

| Vibe | Agentic |
|------|---------|
| Conversational, exploratory | Goal-driven, autonomous |
| "How would you approach…?" | "Create a 3-step checkout with…" |
| Chat, iterate, discover | One prompt, full outcome |
| Great for ideation | Great for implementation |

---

## Quick setup steps

1. Go to [miro.com](https://miro.com) and create a new board.
...
- **Before:** Share view-only or edit link so everyone can add content.
- **During:** Everyone can add stickies, screenshots, or text.
- **After:** Export or keep as a record of the session.
